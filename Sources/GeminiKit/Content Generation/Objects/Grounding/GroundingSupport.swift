...
public struct GroundingSupport: Codable {
	...
	public init(groundingChunkIndices: [Int]? = nil, confidenceScores: [Float]? = nil, segment: Segment? = nil) {
	...
	public struct Segment: Codable {
		...
		public init(partIndex: Int? = nil, startIndex: Int? = nil, endIndex: Int? = nil, text: String? = nil) {
